...
export const Header = ({ onMobileMenuOpen }: NavBarProps) => {
	...
	return (
		...
		<button
			className={`lg:hidden flex items-center justify-center w-8 h-8 rounded-lg border transition-all ${btnBg} ${textSec} hover:border-customTealLight hover:text-customTealLight`}
